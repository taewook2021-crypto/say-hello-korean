-- 1. 잘못된 데이터 정리
DELETE FROM major_chapters WHERE subject_name = '잼회';

-- 2. 외래키 제약을 CASCADE로 변경하여 자동 업데이트 허용
...
-- major_chapters 테이블의 book_name, subject_name이 books를 참조
ALTER TABLE major_chapters 
...
-- chapters 테이블의 book_name, subject_name이 books를 참조
ALTER TABLE chapters 
