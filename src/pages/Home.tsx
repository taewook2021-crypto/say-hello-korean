...
import { BookOpen, Plus, ChevronRight, ChevronDown, Minus, Edit, LogIn, LogOut, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">오답노트</h1>
            <p className="text-lg text-muted-foreground">
              체계적인 학습을 위한 스마트 오답 관리 시스템
            </p>
          </div>
